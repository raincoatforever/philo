...
# Ruby, Python, Go, or C. You are encouraged to use packages or libraries to
# deal with sockets.
#
...
class StackTest < Test::Unit::TestCase
  ...
  #
  # issue 100 simultaneous slow pushes. they should all be removed for a full
  # stack push/pop sequence
  #
  def test_all_slow_clients_get_killed_for_fast_clients
    puts "test_all_slow_clients_get_killed_for_fast_clients"
    start_slow_clients(nclients: 100)
    sleep 12
